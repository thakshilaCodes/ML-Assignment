"""Train Logistic Regression classifier on Train_Dataset.csv."""
...
MODEL_OUT = ROOT / "outputs/trained_models/logistic_regression.joblib"
METRICS_OUT = ROOT / "outputs/metrics/logistic_regression.txt"

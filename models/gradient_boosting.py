"""Train sklearn Gradient Boosting classifier on Train_Dataset.csv."""
...
MODEL_OUT = ROOT / "outputs/trained_models/gradient_boosting.joblib"
METRICS_OUT = ROOT / "outputs/metrics/gradient_boosting.txt"

"""Train Random Forest classifier on Train_Dataset.csv."""
...
MODEL_OUT = ROOT / "outputs/trained_models/random_forest.joblib"
METRICS_OUT = ROOT / "outputs/metrics/random_forest.txt"
